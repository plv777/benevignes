 ...
 */
final class Version20180619094740 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(320) NOT NULL, password VARCHAR(60) NOT NULL, active TINYINT(1) NOT NULL, type INT NOT NULL, active_token VARCHAR(32) NOT NULL, wine_area VARCHAR(25) DEFAULT NULL, name VARCHAR(60) NOT NULL, first_name VARCHAR(60) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
